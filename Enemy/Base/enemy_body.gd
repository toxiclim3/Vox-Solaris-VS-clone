...
var xp_orb = preload("res://Objects/xp_orb.tscn")
...
func death():
	...
	if randf() < 0.01:
		var new_xp_orb = xp_orb.instantiate()
		new_xp_orb.global_position = global_position
		loot_base.call_deferred("add_child",new_xp_orb)
